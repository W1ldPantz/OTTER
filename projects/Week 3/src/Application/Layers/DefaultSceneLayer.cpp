...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("Assignment1.json")) {
		app.LoadScene("Assignment1.json");
	} else {
		...
		scene->Lights[0].Position = glm::vec3(2.0f, 1.0f, 3.0f);
		...
		{
			camera->SetPostion({ 0.1, 0.0, 15.0 });
		...
		GameObject::Sptr monkey1 = scene->CreateGameObject("Monkey 1");
		{
			...
			monkey1->SetPostion(glm::vec3(0.210f, 0.0f, 1.0f));
		...
		GameObject::Sptr specBox = scene->CreateGameObject("Specular Object");
		{
			...
			specBox->SetPostion(glm::vec3(-0.090, -9.670f, 1.0f));
		...
		{
			// Set and rotation position in the scene
			foliageBall->SetPostion(glm::vec3(-4.840f, -9.670f, 1.0f));
		...
		GameObject::Sptr foliageBox = scene->CreateGameObject("Foliage Box");
		{
			...
			// Set and rotation position in the scene
			foliageBox->SetPostion(glm::vec3(-4.960f, -4.320f, 1.0f));
		...
		{
			// Set and rotation position in the scene
			toonBall->SetPostion(glm::vec3(-4.960f, 0.100f, 1.0f));
		...
		{
			// Set and rotation position in the scene
			displacementBall->SetPostion(glm::vec3(4.800f, -9.380f, 1.0f));
		...
		{
			// Set and rotation position in the scene 
			multiTextureBall->SetPostion(glm::vec3(4.94f, -4.710f, 1.0f));
		...
		{
			// Set and rotation position in the scene 
			normalMapBall->SetPostion(glm::vec3(4.740f, -0.020f, 1.0f));
